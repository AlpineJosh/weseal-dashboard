...
export default function ComponentLayout({
  ...
  return (
    <div className="flex max-w-screen-xl grow flex-col space-y-4">
      {data && (
        <div className="flex flex-col gap-4">
          <div className="flex flex-col gap-2">
            ...
            <Text className="text-content-muted">{data.supplierName}</Text>
      ...
      <TabBar>
        <TabBar.Tab href={`/receiving/orders/${id}`}>Overview</TabBar.Tab>
        <TabBar.Tab href={`/receiving/orders/${id}/receipts`}>
          Receipts
        </TabBar.Tab>
      </TabBar>
      <div>{children}</div>
